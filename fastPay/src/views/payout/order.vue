...
<template>
  ...
  <el-table v-loading="loading" :data="tableData" border style="width: 100%">
    ...
    <el-table-column prop="merchantNum" :label="$t('table.merchant_order_no')" width="120" />
    <el-table-column prop="platformName" :label="$t('table.merchant_order_no')" width="120" />
    ...
    <el-table-column prop="payment_bank_card" :label="$t('table.payment_bank_card')" width="120" />
